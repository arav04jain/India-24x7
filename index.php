...
<body style="background-color: whitesmoke;">
  ...
  <!--content-->
  <h1 style="font-size: 75px; font-weight: 750; color: red; text-align: center;">India 24x7</h1>
  <br>
  ...
  $res = mysqli_query($mysqli,"SELECT COUNT(*) FROM articles;");
  $num=intval(implode(mysqli_fetch_assoc($res)));
  for($x=0;$x<$num;$x++){
    $idts= intval(implode(mysqli_fetch_assoc(mysqli_query($mysqli,"select id from articles ORDER BY id DESC limit ".$x.",1;"))));
