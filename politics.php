...
<body style="background-color: whitesmoke;">
  ...
  <!--content-->
  <h1 style="font-size: 75px; font-weight: 750; color: red; text-align: center;">Political News</h1>
  <br>
  ...
  $res = mysqli_query($mysqli,"SELECT COUNT(*) FROM articles where subject='Political News';");
  $num=intval(implode(mysqli_fetch_assoc($res)));
  for($x=0;$x<$num;$x++){
    $u="select id from articles where subject= 'Political News' ORDER BY id DESC limit ".$x.",1;";
